...
extension Color {
    static let appBackground  = Color(red: 10/255,  green: 0/255,  blue: 28/255)
    static let appBackgroundDarkGrey  = Color(red: 36/255,  green: 36/255,  blue: 36/255)
    static let appBackgroundBlue  = Color(red: 10/255,  green: 22/255,  blue: 42/255)
